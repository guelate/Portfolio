...
//     <Card
//       id={id}
//       className="relative border pb-1 pr-1 rounded-lg border-gray-300 bg-gray-100"
//     >
...
//         <div className="flex justify-between ml-12 mt-14 items-center group w-16">
//           <Badge
//             variant="secondary"
//             className="border border-blue-50 bg-blue-100 hover:bg-blue-200 hover:border-blue-300 ml-auto relative z-10"
//           >
//             Details
//           </Badge>

//           <div className="absolute hidden group-hover:flex flex-col border border-gray-400 text-gray-700 p-2 z-10 w-3/6 gap-1 -translate-y-16 translate-x-11 rounded-lg bg-gray-200">
